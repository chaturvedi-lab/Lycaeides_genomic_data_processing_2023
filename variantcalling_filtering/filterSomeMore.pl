...
my $maxCoverage = 9711; # maximum depth to avoid repeats, mean + 2sd = 17162.16
...
### get set of SNPs and precompute distances ##
...
my $in = shift(@ARGV);
#specify vcf file
open (IN, "variantsLycaeides.vcf") or die "Could not read the infile = $in\n";
